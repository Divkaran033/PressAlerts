...
export class navbar extends Component {
  ...
  <div className="container-fluid">
    <Link className="navbar-brand" to="/" style={{color: "#f11946 ", fontSize: "60px"}}><b>PressAlert</b> </Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0 mx-10" style={{marginTop: "30px"}}>
        <li className="nav-item" style={{marginLeft: "120px"}}><Link className="nav-link active" aria-current="page" to="/">Home</Link></li>
